...
public :
    ...
    bool operator()(ListNode* a, ListNode* b) {
        if (b->val < a->val) {
            // do a swap to build a minHeap based on node values
            return true;
        }
...
ListNode* mergeKSortedLL(vector<ListNode*> v) {
    ...
    priority_queue <ListNode*, vector<ListNode*>, nodeFunctor> minHeap(v.begin(), v.end());
...
int main() {
    ...
    ListNode* head = mergeKSortedLL(v);
